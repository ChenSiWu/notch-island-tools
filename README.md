...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Atoll | 推荐，开源 | 4.4k+ | Release v2.3.3，2026-07-24；仓库最近更新 2026-09-07 | [GitHub](https://github.com/Ebullioscopic/Atoll) / [Release](https://github.com/Ebullioscopic/Atoll/releases/latest) | 官方写明支持 Apple Music、Spotify 等媒体控制，还包括系统状态、Live Activities、锁屏小组件、文件 Shelf、剪贴板、日历、计时器。当前最适合当主力 |
| 2 | BoringNotch | 推荐，开源 | 10.6k+ | Release v2.7.3，2025-11-24；仓库最近更新 2026-09-05 | [官网](https://boringnotch.com/) / [GitHub](https://github.com/TheBoredTeam/boring.notch) / [Release](https://github.com/TheBoredTeam/boring.notch/releases/latest) | 官网强调媒体控制、文件 Shelf、日历、镜子、电池、HUD 替换。功能没有 Atoll 满，但作为开源备用很稳 |
...
| 5 | MacNotch | 可试，闭源商业 | 无 | Setapp 版本 1.9.9.4 | [Setapp](https://setapp.com/apps/macnotch) | Setapp 写明支持 Spotify、Apple Music、YouTube、浏览器播放器，还包含任务、事件、计时器、小组件、设备电量、文件 Drop、HUD、OpenAI/Ollama 翻译。Setapp 用户值得试 |
...
| 3 | MioIsland | 推荐，开源非商业许可 | 543 | Release v2.1.7，2026-04-18；仓库活跃 | [GitHub](https://github.com/MioMioOS/MioIsland) / [Release](https://github.com/MioMioOS/MioIsland/releases/latest) | Claude Code 深度体验强：像素猫、/buddy、刘海审批、AskUserQuestion、Codex、iPhone Code Light、插件市场、Stats/Music 插件 |
...
| 6 | xisland | 推荐/可试，免费 | 12+ | 官网显示 v0.2.0；Homebrew 安装明确 | [官网](https://xisland.app/) / [GitHub](https://github.com/bluedusk/xisland) / [Release](https://github.com/bluedusk/xisland/releases/latest) | 免费、Swift 原生，支持 Claude Code、Codex、Gemini CLI、OpenCode；有 Notch/Pill 模式、审批、回答、终端跳转、键盘优先 |
