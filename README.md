...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Atoll | 推荐，开源 | 2k+ | Release v2.1.0，2026-03-21；仓库最近更新 2026-05-21 | [GitHub](https://github.com/Ebullioscopic/Atoll) / [Release](https://github.com/Ebullioscopic/Atoll/releases/latest) | 官方写明支持 Apple Music、Spotify 等媒体控制，还包括系统状态、Live Activities、锁屏小组件、文件 Shelf、剪贴板、日历、计时器。当前最适合当主力 |
| 2 | BoringNotch | 推荐，开源 | 9.3k+ | Release v2.7.3，2025-11-24；仓库最近更新 2026-05-25 | [官网](https://boringnotch.com/) / [GitHub](https://github.com/TheBoredTeam/boring.notch) / [Release](https://github.com/TheBoredTeam/boring.notch/releases/latest) | 官网强调媒体控制、文件 Shelf、日历、镜子、电池、HUD 替换。功能没有 Atoll 满，但作为开源备用很稳 |
...
| 5 | MacNotch | 可试，闭源商业 | 无 | Setapp 版本 1.8.9.3 | [Setapp](https://setapp.com/apps/macnotch) | Setapp 写明支持 Spotify、Apple Music、YouTube、浏览器播放器，还包含任务、事件、计时器、小组件、设备电量、文件 Drop、HUD、OpenAI/Ollama 翻译。Setapp 用户值得试 |
...
| 7 | NookX | 可试，闭源 App Store | 无 | App Store 当前版本 2026.05.05，发布日期 2026-05-03 | [App Store](https://apps.apple.com/us/app/nook-x-%E6%95%88%E7%8E%87%E5%B2%9B-notch-%E7%95%AA%E8%8C%84%E9%92%9F-%E5%88%98%E6%B5%B7-todo/id6733240772?mt=12) | 中文效率岛，适合 Todo、番茄钟、天气、快捷启动、速记、展开动效。官方写第三方音乐 / Safari，实际音乐兼容性需要按播放器验证 |
...
| 排名 | 工具 | 状态 | GitHub Stars | 更新/热度/反馈 | 地址 | 官方功能范围与我的判断 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | CodeIsland | 推荐，开源 MIT | 1.6k+ | Release v1.0.24，2026-04-29；仓库最近更新 2026-05-10 | [GitHub](https://github.com/wxtsky/CodeIsland) / [Release](https://github.com/wxtsky/CodeIsland/releases/latest) | 支持 Claude Code、Codex、Gemini CLI、Cursor、Copilot、Trae、Qoder、Factory、CodeBuddy、OpenCode、Kimi Code CLI；像素风角色、自动 Hook、权限审批、问题回答、一键跳转 |
| 2 | Open Island | 推荐，开源 GPL-3.0 | 1.1k+ | Release v1.1.2，2026-05-12；仓库最近更新 2026-05-13 | [GitHub](https://github.com/Octane0411/open-vibe-island) / [Release](https://github.com/Octane0411/open-vibe-island/releases/latest) | 开源、local-first、无账号无遥测，Agent 和终端/IDE 覆盖很广。适合和 CodeIsland 做同场景对比 |
| 3 | MioIsland | 推荐，开源非商业许可 | 472 | Release v3.0.0，2026-05-13；仓库最近更新 2026-05-23 | [GitHub](https://github.com/MioMioOS/MioIsland) / [Release](https://github.com/MioMioOS/MioIsland/releases/latest) | Claude Code 深度体验强：像素猫、/buddy、刘海审批、AskUserQuestion、Codex、iPhone Code Light、插件市场、Stats/Music 插件 |
| 4 | Vibe Island | 推荐，闭源商业 | 无 | Homebrew Cask 1.0.33 | [官网](https://vibeisland.app/) / [下载页](https://vibeisland.app/download) | 商业化完整体验：零配置、GUI 审批、问题回答、Plan Review、用量追踪、SSH Remote、13+ 终端、纯 Swift。开源方案不稳时考虑 |
| 5 | Claude Island | 推荐，开源 Apache-2.0 | 2.3k+ | Release v1.3.2，2026-04-20；仓库最近更新 2026-04-20 | [官网](https://claudeisland.com/) / [GitHub](https://github.com/farouqaldori/claude-island) / [Release](https://github.com/farouqaldori/claude-island/releases/latest) | Claude Code 专用，权限提醒、实时监控、多会话、聊天历史、SwiftUI 原生 |
| 6 | xisland | 推荐/可试，免费 | 16 | Release v0.18.0，2026-05-02；仓库最近更新 2026-05-02 | [官网](https://xisland.app/) / [GitHub](https://github.com/bluedusk/xisland) / [Release](https://github.com/bluedusk/xisland/releases/latest) | 免费、Swift 原生，支持 Claude Code、Codex、Gemini CLI、OpenCode；有 Notch/Pill 模式、审批、回答、终端跳转、键盘优先 |
| 7 | Notchi | 可试，开源 GPL-3.0 | 891 | Release v1.1.2，2026-05-18；仓库最近更新 2026-05-21 | [官网](https://notchi.app/) / [GitHub](https://github.com/sk-ruban/notchi) / [DMG](https://github.com/sk-ruban/notchi/releases/download/v1.0.5/Notchi-1.0.5.dmg) | Claude Code companion，实时响应 thought、tool call、error；要求 macOS Sequoia |
| 8 | Clautch | 可试，源码可见 | 0 | Release v0.29.0，2026-05-17；仓库最近更新 2026-05-17 | [官网](https://clautch.app/) / [GitHub](https://github.com/sophiie-ai/clautch) / [Release](https://github.com/sophiie-ai/clautch/releases/latest) | Claude Code 状态宠物，带团队房间、聊天、像素反应和等待输入提醒，更偏陪伴和团队氛围 |
...
| 10 | Ping Island | 观察，开源 Apache-2.0 | 720 | Release v0.16.0，2026-05-21；仓库最近更新 2026-05-21 | [主页](https://erha19.github.io/ping-island) / [GitHub](https://github.com/erha19/ping-island) / [Release](https://github.com/erha19/ping-island/releases/latest) | Vibe Island 风格，支持审批、追问、窗口跳转，适合作为开源替代观察 |
| 11 | Notch Pilot | 观察，开源 MIT | 59 | Release v0.4.12，2026-04-30；仓库最近更新 2026-04-30 | [GitHub](https://github.com/devmegablaster/Notch-Pilot) / [Release](https://github.com/devmegablaster/Notch-Pilot/releases/latest) | Claude 用量、会话状态、权限提示、动画 buddy；先观察稳定性 |
...
| NotchBar | 观察，开源 AGPL-3.0 | 131 | 官网版本 1.5.4 | [官网](https://deepak-kumar.github.io/NotchBar-Distribution/) / [GitHub](https://github.com/navtoj/NotchBar) | 媒体、系统状态、文件托盘、截图/录屏、全局热键，像开源控制中心，但版本信息不一致 |
| MediaMate | 归档/边界类 | 无 | 官网可访问，页面版权停在 2024 | [官网](https://wouter01.github.io/MediaMate/) | 更像媒体/HUD 工具，不是完整灵动岛 |
| Notchy | 观察，开源 MIT | 706 | 仓库 2026-03 活跃，但无 Release，要求 macOS 26.0+ | [GitHub](https://github.com/adamlyttleapps/notchy) | Xcode + Claude 的内嵌终端面板，需要源码构建 |
