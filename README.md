...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Atoll | 推荐，开源 | 4.7k+ | Release v2.3.3，2026-07-24；仓库最近更新 2026-09-21 | [GitHub](https://github.com/Ebullioscopic/Atoll) / [Release](https://github.com/Ebullioscopic/Atoll/releases/latest) | 官方写明支持 Apple Music、Spotify 等媒体控制，还包括系统状态、Live Activities、锁屏小组件、文件 Shelf、剪贴板、日历、计时器。当前最适合当主力 |
| 2 | BoringNotch | 推荐，开源 | 10.8k+ | Release v2.7.3，2025-11-24；仓库最近更新 2026-09-21 | [官网](https://boringnotch.com/) / [GitHub](https://github.com/TheBoredTeam/boring.notch) / [Release](https://github.com/TheBoredTeam/boring.notch/releases/latest) | 官网强调媒体控制、文件 Shelf、日历、镜子、电池、HUD 替换。功能没有 Atoll 满，但作为开源备用很稳 |
...
| 7 | NookX | 可试，闭源 App Store | 无 | App Store 当前版本 2026.09.15，发布日期 2026-09-14 | [App Store](https://apps.apple.com/us/app/nook-x-%E6%95%88%E7%8E%87%E5%B2%9B-notch-%E7%95%AA%E8%8C%84%E9%92%9F-%E5%88%98%E6%B5%B7-todo/id6733240772?mt=12) | 中文效率岛，适合 Todo、番茄钟、天气、快捷启动、速记、展开动效。官方写第三方音乐 / Safari，实际音乐兼容性需要按播放器验证 |
...
| 2 | Open Island | 推荐，开源 GPL-3.0 | 2k+ | Release v1.2.1，2026-09-15；仓库最近更新 2026-09-15 | [GitHub](https://github.com/Octane0411/open-vibe-island) / [Release](https://github.com/Octane0411/open-vibe-island/releases/latest) | 开源、local-first、无账号无遥测，Agent 和终端/IDE 覆盖很广。适合和 CodeIsland 做同场景对比 |
| 3 | MioIsland | 推荐，开源非商业许可 | 543 | Release v3.1.3，2026-08-13；仓库最近更新 2026-08-14 | [GitHub](https://github.com/MioMioOS/MioIsland) / [Release](https://github.com/MioMioOS/MioIsland/releases/latest) | Claude Code 深度体验强：像素猫、/buddy、刘海审批、AskUserQuestion、Codex、iPhone Code Light、插件市场、Stats/Music 插件 |
...
| 7 | Notchi | 可试，开源 GPL-3.0 | 1k+ | Release v1.2.7，2026-09-19；仓库最近更新 2026-09-21 | [官网](https://notchi.app/) / [GitHub](https://github.com/sk-ruban/notchi) / [DMG](https://github.com/sk-ruban/notchi/releases/download/v1.0.5/Notchi-1.0.5.dmg) | Claude Code companion，实时响应 thought、tool call、error；要求 macOS Sequoia |
...
| 10 | Ping Island | 观察，开源 Apache-2.0 | 1.1k+ | Release v0.3.0，2026-04-18；仓库活跃但项目早期 | [主页](https://erha19.github.io/ping-island) / [GitHub](https://github.com/erha19/ping-island) / [Release](https://github.com/erha19/ping-island/releases/latest) | Vibe Island 风格，支持审批、追问、窗口跳转，适合作为开源替代观察 |
