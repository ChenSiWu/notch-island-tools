...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Atoll | 推荐，开源 | 2k+ | Release v2.1.0，2026-03-21；仓库最近更新 2026-05-18 | [GitHub](https://github.com/Ebullioscopic/Atoll) / [Release](https://github.com/Ebullioscopic/Atoll/releases/latest) | 官方写明支持 Apple Music、Spotify 等媒体控制，还包括系统状态、Live Activities、锁屏小组件、文件 Shelf、剪贴板、日历、计时器。当前最适合当主力 |
| 2 | BoringNotch | 推荐，开源 | 9.2k+ | Release v2.7.3，2025-11-24；仓库最近更新 2026-05-16 | [官网](https://boringnotch.com/) / [GitHub](https://github.com/TheBoredTeam/boring.notch) / [Release](https://github.com/TheBoredTeam/boring.notch/releases/latest) | 官网强调媒体控制、文件 Shelf、日历、镜子、电池、HUD 替换。功能没有 Atoll 满，但作为开源备用很稳 |
...
| 5 | MacNotch | 可试，闭源商业 | 无 | Setapp 版本 1.8.9 | [Setapp](https://setapp.com/apps/macnotch) | Setapp 写明支持 Spotify、Apple Music、YouTube、浏览器播放器，还包含任务、事件、计时器、小组件、设备电量、文件 Drop、HUD、OpenAI/Ollama 翻译。Setapp 用户值得试 |
...
| 3 | MioIsland | 推荐，开源非商业许可 | 459 | Release v3.0.0，2026-05-13；仓库最近更新 2026-05-13 | [GitHub](https://github.com/MioMioOS/MioIsland) / [Release](https://github.com/MioMioOS/MioIsland/releases/latest) | Claude Code 深度体验强：像素猫、/buddy、刘海审批、AskUserQuestion、Codex、iPhone Code Light、插件市场、Stats/Music 插件 |
...
| 5 | Claude Island | 推荐，开源 Apache-2.0 | 2.3k+ | Release v1.3.1，2026-04-15；Claude 专用热度高 | [官网](https://claudeisland.com/) / [GitHub](https://github.com/farouqaldori/claude-island) / [Release](https://github.com/farouqaldori/claude-island/releases/latest) | Claude Code 专用，权限提醒、实时监控、多会话、聊天历史、SwiftUI 原生 |
| 6 | xisland | 推荐/可试，免费 | 15 | Release v0.18.0，2026-05-02；仓库最近更新 2026-05-02 | [官网](https://xisland.app/) / [GitHub](https://github.com/bluedusk/xisland) / [Release](https://github.com/bluedusk/xisland/releases/latest) | 免费、Swift 原生，支持 Claude Code、Codex、Gemini CLI、OpenCode；有 Notch/Pill 模式、审批、回答、终端跳转、键盘优先 |
...
| NotchBar | 观察，开源 AGPL-3.0 | 120+ | 官网版本 1.5.4 | [官网](https://deepak-kumar.github.io/NotchBar-Distribution/) / [GitHub](https://github.com/navtoj/NotchBar) | 媒体、系统状态、文件托盘、截图/录屏、全局热键，像开源控制中心，但版本信息不一致 |
