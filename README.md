...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Atoll | 推荐，开源 | 3.9k+ | Release v2.3.3，2026-07-24；仓库最近更新 2026-08-13 | [GitHub](https://github.com/Ebullioscopic/Atoll) / [Release](https://github.com/Ebullioscopic/Atoll/releases/latest) | 官方写明支持 Apple Music、Spotify 等媒体控制，还包括系统状态、Live Activities、锁屏小组件、文件 Shelf、剪贴板、日历、计时器。当前最适合当主力 |
| 2 | BoringNotch | 推荐，开源 | 10.4k+ | Release v2.7.3，2025-11-24；仓库最近更新 2026-08-16 | [官网](https://boringnotch.com/) / [GitHub](https://github.com/TheBoredTeam/boring.notch) / [Release](https://github.com/TheBoredTeam/boring.notch/releases/latest) | 官网强调媒体控制、文件 Shelf、日历、镜子、电池、HUD 替换。功能没有 Atoll 满，但作为开源备用很稳 |
...
| 5 | MacNotch | 可试，闭源商业 | 无 | Setapp 版本 1.9.9 | [Setapp](https://setapp.com/apps/macnotch) | Setapp 写明支持 Spotify、Apple Music、YouTube、浏览器播放器，还包含任务、事件、计时器、小组件、设备电量、文件 Drop、HUD、OpenAI/Ollama 翻译。Setapp 用户值得试 |
...
| 3 | MioIsland | 推荐，开源非商业许可 | 527 | Release v3.1.3，2026-08-13；仓库最近更新 2026-08-14 | [GitHub](https://github.com/MioMioOS/MioIsland) / [Release](https://github.com/MioMioOS/MioIsland/releases/latest) | Claude Code 深度体验强：像素猫、/buddy、刘海审批、AskUserQuestion、Codex、iPhone Code Light、插件市场、Stats/Music 插件 |
...
| 7 | Notchi | 可试，开源 GPL-3.0 | 997 | Release v1.2.3，2026-08-08；仓库最近更新 2026-08-11 | [官网](https://notchi.app/) / [GitHub](https://github.com/sk-ruban/notchi) / [DMG](https://github.com/sk-ruban/notchi/releases/download/v1.0.5/Notchi-1.0.5.dmg) | Claude Code companion，实时响应 thought、tool call、error；要求 macOS Sequoia |
...
| 10 | Ping Island | 观察，开源 Apache-2.0 | 1.1k+ | Release v0.27.3，2026-08-15；仓库最近更新 2026-08-15 | [主页](https://erha19.github.io/ping-island) / [GitHub](https://github.com/erha19/ping-island) / [Release](https://github.com/erha19/ping-island/releases/latest) | Vibe Island 风格，支持审批、追问、窗口跳转，适合作为开源替代观察 |
| 11 | Notch Pilot | 观察，开源 MIT | 66 | Release v0.4.12，2026-04-30；仓库最近更新 2026-04-30 | [GitHub](https://github.com/devmegablaster/Notch-Pilot) / [Release](https://github.com/devmegablaster/Notch-Pilot/releases/latest) | Claude 用量、会话状态、权限提示、动画 buddy；先观察稳定性 |
...
| NotchBar | 观察，开源 AGPL-3.0 | 129 | 仓库 2025-12 活跃；官网写 1.5.4，但 GitHub 最新公开 Release 是 2025-01 prerelease | [官网](https://deepak-kumar.github.io/NotchBar-Distribution/) / [GitHub](https://github.com/navtoj/NotchBar) | 媒体、系统状态、文件托盘、截图/录屏、全局热键，像开源控制中心，但版本信息不一致 |
| MediaMate | 归档/边界类 | 无 | 官网可访问，页面版权停在 2024 | [官网](https://wouter01.github.io/MediaMate/) | 更像媒体/HUD 工具，不是完整灵动岛 |
| Notchy | 观察，开源 MIT | 714 | 仓库 2026-03 活跃，但无 Release，要求 macOS 26.0+ | [GitHub](https://github.com/adamlyttleapps/notchy) | Xcode + Claude 的内嵌终端面板，需要源码构建 |
